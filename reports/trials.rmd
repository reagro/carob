...
The dataset has `r nrow(d)` records for variety trials of `r crop` in `r country`. These are the first `r min(nrow(d), 25)` records: 
...
The dataset has data for `r length(varieties)` varieties 
