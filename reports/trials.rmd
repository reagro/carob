...
The dataset has `r nrow(d)` records for variety trials of `r crop` in `r country`. There are `r length(varieties)` varieties. These are the first `r min(nrow(d), 25)` records: 
