...
pub <- ifelse(is.na(m$publication), "", paste0('You can also consult the accompanying <a href="', yuri:::http_address(m$publication), '">paper</a>.'))
```
