...
This dataset combines `r nsources` standardized individual data [sources](https://carob-data.org/done.html). It has has `r nrow(d)` records and `r ncol(d)` variables for `r crop` and `r country`. `r vartxt`
