...
"
   ...
   dset <- data.frame(
      ...
      project=NA, 
      uri=uri, 
      data_citation="Roobroeck, D., Rebbeca, H.-N., John-Baptist, T., & Jackson, M. (2019). IITA-ADC biochar study Uganda on Sorghum [dataset]. International Institute of Tropical Agriculture (IITA).
  ...
  dset$title <- carobiner::get_title(js)
   ...
   r <- read.csv(ff[bn=="Sorghum_biomass_sampling.csv"])
