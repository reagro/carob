...
carob_script <- function(path) {
   ...
   "  
   Evaluation of yield under late blight and viral disease presence, in Kenya. In the first experiment,16 clones were evaluated under RCBD with 3 repetitions.
   In the second experiment, 32 clones were evaluated in RCBD with 3 reps. Both trials were established at University of Nairobi, Kabete Campus, Nairobi-Kenya (1800 m a.s.l.).
   All late blight evaluations were performed 30, 40, 50, 60, 70, 80 and 90 days after planting. The plots were set with a distance of 0.75 m between rows and 0.20 m plants
   "
   ...
   d1 <- lapply(c("2018-07-17_Fieldbook_Trial1","2018-07-22_Fieldbook_Trial2"), \(i){ 
   ...
   d$adm1 <- "Nairobi"
   d$adm2 <- "Kabete"
   d$location <- "university of Nairobi"
