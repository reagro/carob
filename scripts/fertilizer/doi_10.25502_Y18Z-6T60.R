...
"
  ...
  d1[c('crop', 'crop1','crop2','crop3')] <- str_split_fixed(d1$crop, "/", 4)
  d1[c('yield1', 'yield2','yield3','yield4')] <- str_split_fixed(d1$yield1, "/", 4)
  
  d1[c('variety', 'variety1','variety2','variety3')] <- str_split_fixed(d1$variety, "/", 4)
 ...
 # we split again d1e3
 d1e3[c('crop3', 'crop1','crop2')] <- str_split_fixed(d1e3$crop3, "/", 3)
 d1e3[c('yield4', 'yield2','yield3')] <- str_split_fixed(d1e3$yield4, "/", 3)
 d1e3[c('variety3', 'variety1','variety2')] <- str_split_fixed(d1e3$variety3, "/", 3)
