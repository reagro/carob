...
"
  ...
  for (i in 1:nrow(c)) {
    if(is.na(c$grain_weight1[i]) & !is.na(c$grain_weight2[i])){
  ...
  for (i in 1:nrow(d)) {
    if (d$Year[i] == 1 & d$crop[i] == "maize") {
      d$planting_date[i] <- "2017-12-01"
      d$harvest_date[i] <- "2018-05-05"
    } else if (d$Year[i] == 2 & d$crop[i] == "maize") {
      d$planting_date[i] <- "2018-12-04"
      d$harvest_date[i] <- "2019-04-22"
    } else if (d$Year[i] == 1 & d$crop[i] == "cowpea") {
      d$planting_date[i] <- "2018-01-01"
      d$harvest_date[i] <- "2018-05-05"
    } else if (d$Year[i] == 2 & d$crop[i] == "cowpea" & d$Cowpea_variety[i] == "Landrace") {
      d$planting_date[i] <- "2018-12-18"
      d$harvest_date[i] <- "2019-04-22"
    } else if (d$Year[i] == 2 & d$crop[i] == "cowpea" & d$Cowpea_variety[i] == "Improved") {
      d$planting_date[i] <- "2018-12-18"
