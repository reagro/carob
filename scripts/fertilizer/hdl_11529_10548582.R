...
"
	...
	dset <- data.frame(
	   ...
	   group=group,
	   uri=uri,
	   publication="hdl:11529/10548582",
...
## download and read data 
	...
	# process file(s)
	d <- d[,c("country", "adm1", "adm2", "trial_id", "latitude", "longitude", "start_date", "end_date", "on_farm", "is_survey", "treatments", "rep", "crop", "variety", "biomass_total", "yield", "residue_yield", "grain_weight")]
