...
p<-gsub("maize;sweetpotato","maize; sweetpotato",p)
p<-gsub("cowpeas","cowpea",p)
p<-gsub("maize & cassava","maize; cassava",p)
p<-gsub("maize;sweetpotato;cassava","maize; sweetpotato; cassava",p)
p<-gsub("maize;groundnut;cassava","maize; groundnut; cassava",p)
p<-gsub("sweetpotato;cassava","sweetpotato; cassava",p)
p<-gsub("maize;cassava","maize; cassava",p)
