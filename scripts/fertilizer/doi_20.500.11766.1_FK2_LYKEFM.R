...
# This refers to the treatment levels indicated in "Treatment.csv"	
 ...
 # This refers to the splits indicated in "Treatment.csv"
	...
	# see "Experimental_Layout.png"
		...
		d <- d[,c("country", "location", "trial_id", "latitude", "longitude", "planting_date", "harvest_date", "on_farm", "is_survey", "treatment", "rep", "crop", "yield", "N_fertilizer", "N_splits", "P_fertilizer", "K_fertilizer", "plant_spacing")]
		dd <- rbind(dd,d) 
	}
