...
"
RM: note that yield data provided is a rating hence data is out of scope for us until we know what amount the ratings stand for
                        ...
                        ifelse(z$site == "Kasungu" & is.na(z$longitude),33.472356695915096,
                               ifelse(z$site == "Lilongwe" & is.na(z$longitude),33.735370838170624,
                                      ifelse(z$site == "Dedza" & is.na(z$longitude),34.31965143966403,
                                             ifelse(z$site == "Mzimba" & is.na(z$longitude),33.55783191131472,
                                                    ifelse(z$adm1 == "Kasungu" & z$latitude == -14.00000 & z$longitude == 33.20000,33.30000,
                                                           ifelse(z$adm1 == "Kasungu" & z$latitude == -12.20000 & z$longitude == 33.30000,33.40000,
                                                                  ifelse(z$adm1 == "Kasungu" & z$latitude == -12.30000 & z$longitude == 33.30000,33.40000,
                                                                         ifelse(z$adm1 == "Kasungu" & z$latitude == -12.40000 & z$longitude == 33.30000,33.60000,
                                                                                ifelse(z$adm1 == "Kasungu" & z$latitude == -12.40000 & z$longitude == 33.40000,33.60000,
                                                                                       ifelse(z$adm1 == "Dedza" & z$latitude == -14.20000 & z$longitude == 35.50000,35.40000,
                                                                                              ifelse(z$adm1 == "Dedza" & z$latitude == -13.20000 & z$longitude == 34.90000,34.30000,
                                                                                                     ifelse(z$adm1 == "Mzimba" & z$latitude == -12.20000 & z$longitude == 33.30000,33.40000,
                                                                                                            ifelse(z$adm1 == "Mchinji" & z$latitude == -14.0 & z$longitude == 33.20000,33.30000,
                                                                                                                   z$longitude))))))))))))))
