...
## process 001_2014-2015_Wheat_ICRISAT-AR_ETH.xlsx
  ...
  d2$planting_date <- as.character(as.Date(d$Planting.date))
  d2$harvest_date <- as.character(as.Date(d$Harvest.date))
...
## process 002_2016_Wheat_ ICRISAT-AR_ETH.xlsx
  ...
  d3$planting_date <- as.character(as.Date(d$Planting.date))
  d3$harvest_date <-  as.character(as.Date(d$Harvest.date))
...
## process 003_2017_Sorghum+Tef_ ICRISAT-AR_ETH.xlsx
  ...
  d4$planting_date <- as.character(as.Date(d$Planting.date))
  d4$harvest_date <- as.character(as.Date(d$Harvest.date))
...
## process 004_2019_Wheat_ ICRISAT-AR_ETH.xlsx
  ...
  d5$planting_date <- as.character(as.Date(d$Planting.date))
  d5$harvest_date <- as.character(as.Date(d$Harvest.date))
