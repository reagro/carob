...
# Zn_applied_.Kg.ha., Zn_method
	...
	d$latitude[d$site == "Ismailia Governorate"] <- 30.695
	d$latitude[d$site == "Nyankpala"] <- 9.421
	d$latitude[d$site == "Palampur"] <- 32.1
	d$country[d$site %in% c("Gabura", "Tulatuli")] <- "Bangladesh"
