...
carob_script <- function(path) {
  ...
  dset <- data.frame(
   ...
   d2$fertilizer_type <- carobiner::replace_values(
     d2$fertilizer_type,
     c("23:21:0+4s","D-Compound","D-compound","D-Compound; Gypsum (25kgeach)","Super-D","None","N/A","NPK; UREA"),
     c("Compound fertilizer","D compound","D compound","D compound; gypsum","D compound","none",NA,"NPK; urea"))
