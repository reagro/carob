...
"
	...
	dset <- data.frame(
	   ...
	   publication = NA,
	   data_citation = "Global Wheat Program; IWIN Collaborators; Singh, Ravi; Payne, Thomas, 2019, '25th High Rainfall Wheat Yield Trial', hdl:11529/10548226, CIMMYT Research Data & Software Repository Network, V2",
