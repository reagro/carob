...
## (TRUE/FALSE)
	...
	#pH value value is out of bounds(24) whilest on the actual excel document should be 2.4.
	#replacing the out of bound value with the correct value
	d$soil_pH<-carobiner::replace_values(d$soil_pH,24,2.4)
