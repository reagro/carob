...
"Description:
	...
	dset <- data.frame(
		...
		publication= "36th Elite Selection Wheat Yield Trial",
...
## download and read data 
  path <- "C:/Users/Cimmyt/Documents/WORKING DIRECTORY/carob"
	...
	library(readxl)
	X36_ESWYT_RawData_xls <- read_excel("data/raw/wheat_trials/hdl_11529_10989/36 ESWYT_RawData.xls.xlsx")

## process file(s)

## use a subset
	d <- X36_ESWYT_RawData_xls
...
##### Yield #####
	...
	d <- d[,c("dataset_id","record_id", "country","is_experiment","planting_date","rep","crop","yield_part","yield")]
