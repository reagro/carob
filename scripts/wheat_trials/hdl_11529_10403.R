...
"
  ...
  dataset_id <- carobiner::simple_uri(uri)
	...
	dset <- data.frame(
	   ...
	   publication = NA,
	   #data_citation = "Global Wheat Program; IWIN Collaborators; Singh, Ravi; Payne, Thomas, 2017, '34th Elite Selection Wheat Yield Trial', https://hdl.handle.net/11529/10403, CIMMYT Research Data & Software Repository Network, V4, UNF:6:AfZvLHe7tead5GJ77pm+NQ== [fileUNF]",
