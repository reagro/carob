...
"
  uri <- "hdl:11529/10548588"
	...
	dset <- data.frame(
	   ...
	   publication = NA,
	   data_citation = "Global Wheat Program; IWIN Collaborators; Singh, Ravi; Payne, Thomas, 2021, '19th High Temperature Wheat Yield Trial', https://hdl.handle.net/11529/10548588, CIMMYT Research Data & Software Repository Network, V3",
