...
"
	...
	dset <- data.frame(
	   ...
	   publication = NA,
	   #data_citation = "Global Wheat Program; IWIN Collaborators; Singh, Ravi; Payne, Thomas, 2017, '30th Elite Selection Wheat Yield Trial', https://hdl.handle.net/11529/10404, CIMMYT Research Data & Software Repository Network, V3, UNF:6:eqPxHXkap6tCjpMDNP1jqQ== [fileUNF]",
	...
	d <- proc_wheat(ff, dataset_id)#	d$heading[d$country == "Switzerland"] <- NA
