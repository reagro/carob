...
"
	...
	dset <- data.frame(
	   ...
	   publication = NA,
	   data_citation = "Global Wheat Program; IWIN Collaborators; Singh, Ravi; Payne, Thomas, 2019, '28th Elite Selection Wheat Yield Trial', https://hdl.handle.net/11529/10548351, CIMMYT Research Data & Software Repository Network, V1, UNF:6:Lmphi0Y6/8imiVpB1RNBTQ== [fileUNF]",
...
#	d$heading[which(d$heading>300)] <- NA
