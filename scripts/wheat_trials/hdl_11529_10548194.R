...
"
	...
	dset <- data.frame(
	   ...
	   publication = NA,
	   data_citation = "Global Wheat Program; IWIN Collaborators; Singh, Ravi; Payne, Thomas, 2019, '16th High Temperature Wheat Yield Trial', https://hdl.handle.net/11529/10548194, CIMMYT Research Data & Software Repository Network, V3",
