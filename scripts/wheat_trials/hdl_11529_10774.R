...
## (TRUE/FALSE)
	...
	d$previous_crop<-carobiner::replace_values(d$previous_crop,"ground nut","groundnut")
	d$previous_crop<-carobiner::replace_values(d$previous_crop,"sandaemp","sunn hemp")
