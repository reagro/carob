...
"Description:
    ...
    It is distributed to 70 locations, and contains 50 entries. (2012)]"
	...
	dset <- data.frame(
		...
		uri=uri,
		data_citation="Global Wheat Program; IWIN Collaborators; Ammar, Karim; Payne, Thomas, 2012, 44th International Durum Yield Nursery, https://hdl.handle.net/11529/10788, CIMMYT Research Data & Software Repository Network, V1",
		publication=NA,
...
## (TRUE/FALSE)
	...
	d$previous_crop<-carobiner::replace_values(d$previous_crop,"claslerbeen","guar")
	d$previous_crop<-carobiner::replace_values(d$previous_crop,"samhamp","sunn hemp")
