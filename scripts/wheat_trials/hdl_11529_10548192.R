...
"
  ...
  dataset_id <- carobiner::simple_uri(uri)
	...
	dset <- data.frame(
	   ...
	   publication = NA,
	   data_citation = "Global Wheat Program; IWIN Collaborators; Singh, Ravi; Payne, Thomas, 2019, '14th High Temperature Wheat Yield Trial', https://hdl.handle.net/11529/10548192, CIMMYT Research Data & Software Repository Network, V3, UNF:6:nUT7R+5rJbBpoezCfASFFg== [fileUNF]",
