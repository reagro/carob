...
carob_script <- function(path) {
  ...
  df <- data.frame(
      ...
      adm1 = 'Arequipa',
      adm2 = 'Caylloma',
      longitude = -72.28740922406836,
      latitude = -16.376583111880347,
