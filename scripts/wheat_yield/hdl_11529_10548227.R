...
## download and read data 
	...
	env <- ff[basename(ff) == "26TH HRWYT_EnvData.xls"]
	geno <- ff[basename(ff) == "26TH HRWYT_Genotypes_Data.xls"]
	grn <- ff[basename(ff) == "26TH HRWYT_GrnYld.xls"]
	loc <- ff[basename(ff) == "26TH HRWYT_Loc_data.xls"]
	raw <- ff[basename(ff) == "26TH HRWYT_RawData.xls"]
...
# other variables
	...
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "SWEET  POTATOS", "sweetpotato", renv$USE_OF_FIELD_SPECIFY_CROP)
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "FALLOWED", "no crop", renv$USE_OF_FIELD_SPECIFY_CROP)
	...
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "RAPHANUS SPP.", "radish", renv$USE_OF_FIELD_SPECIFY_CROP)
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "LEGUME", "soybean", renv$USE_OF_FIELD_SPECIFY_CROP)
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "MAIZ/SOJA", "maize", renv$USE_OF_FIELD_SPECIFY_CROP)
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "AVENA", "oats", renv$USE_OF_FIELD_SPECIFY_CROP)
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "RAPE SEED", "rapeseed", renv$USE_OF_FIELD_SPECIFY_CROP)
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "TRIGO", "wheat", renv$USE_OF_FIELD_SPECIFY_CROP)
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "PURPERUREUS", "lablab", renv$USE_OF_FIELD_SPECIFY_CROP)
