...
## download and read data 
	...
	env <- ff[basename(ff) == "14TH HRWYT_EnvData.xls"]
	geno <- ff[basename(ff) == "14TH HRWYT_Genotypes_Data.xls"]
	grn <- ff[basename(ff) == "14TH HRWYT_GrnYld.xls"]
	loc <- ff[basename(ff) == "14TH HRWYT_Loc_data.xls"]
	raw <- ff[basename(ff) == "14TH HRWYT_RawData.xls"]
...
# other variables
	...
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "PEAS", "pea", renv$USE_OF_FIELD_SPECIFY_CROP)
	...
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "CORN", "maize", renv$USE_OF_FIELD_SPECIFY_CROP)
		renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "FIELD PEAS", "pea", renv$USE_OF_FIELD_SPECIFY_CROP) # Update once I get clarification
			...
			renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "AVENA+VICIA", "vetch", renv$USE_OF_FIELD_SPECIFY_CROP) # Update once I get clarification
		renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "RAPHA NUS SPP", "vegetables", renv$USE_OF_FIELD_SPECIFY_CROP) # Update once I get clarification
