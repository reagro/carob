...
## download and read data 
	...
	env <- ff[basename(ff) == "11TH HRWYT_EnvData.xls"]
	geno <- ff[basename(ff) == "11TH HRWYT_Genotypes_Data.xls"]
	grn <- ff[basename(ff) == "11TH HRWYT_GrnYld.xls"]
	loc <- ff[basename(ff) == "11TH HRWYT_Loc_data.xls"]
	raw <- ff[basename(ff) == "11TH HRWYT_RawData.xls"]
