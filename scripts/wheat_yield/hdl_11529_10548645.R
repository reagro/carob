...
"
	...
	dset <- data.frame(
	   ...
	   publication = NA,
	   data_citation = "Global Wheat Program; IWIN Collaborators; Singh, Ravi; Payne, Thomas, 2022, '29th High Rainfall Wheat Yield Trial', https://hdl.handle.net/11529/10548645, CIMMYT Research Data & Software Repository Network, V2",
...
## download and read data 
	...
	env <- ff[basename(ff) == "29 HRWYT_EnvData.xls"]
	geno <- ff[basename(ff) == "29 HRWYT_Genotypes_Data.xls"]
	grn <- ff[basename(ff) == "29 HRWYT_GrnYld.xls"]
	loc <- ff[basename(ff) == "29 HRWYT_Loc_data.xls"]
	raw <- ff[basename(ff) == "29 HRWYT_RawData.xls"]
...
# Rename South africa to South Africa
...
# other variables
	...
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "BAJRA", "pearl millet", renv$USE_OF_FIELD_SPECIFY_CROP)
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "GLYCIN MAX", "soybean", renv$USE_OF_FIELD_SPECIFY_CROP)
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "OILSEED", "rapeseed", renv$USE_OF_FIELD_SPECIFY_CROP)
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "OLISEED", "rapeseed", renv$USE_OF_FIELD_SPECIFY_CROP)
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "LAGUME CROP(SOYABEAN)", "soybean", renv$USE_OF_FIELD_SPECIFY_CROP)
	...
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "PULSES", "common bean", renv$USE_OF_FIELD_SPECIFY_CROP)
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "ORYZA SATIVA L.", "rice", renv$USE_OF_FIELD_SPECIFY_CROP)
	...
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "CEREAL", "maize", renv$USE_OF_FIELD_SPECIFY_CROP) # Update once I get clarification
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "LINSEED", "flax", renv$USE_OF_FIELD_SPECIFY_CROP) # Update once I get clarification
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "CROP", "maize", renv$USE_OF_FIELD_SPECIFY_CROP) # Update once I get clarification
