...
carob_script <- function(path) {
  ...
  dset <- data.frame(
    ...
    uri=uri,
    data_citation= "Gathala, Mahesh K. (CIMMYT) - ORCID: 0000-0001-8282-2953, Tiwari, Thakur P. (CIMMYT), Islam, Saiful (CIMMYT) - ORCID: 0000-0002-6482-5031, Ghosh, Anup K. (RDRS-BD), Islam, Rashadul (RDRS-BD), Anwar, Mazharul (BARI-BD), Molla, Samim H. (BARI-BD) - ORCID: 0000-0002-1568-1473, Akhter-Ul-Alam, Md. (BARI-BD).",
