...
## use a subset
	d0 <- data.frame(adm2=r0$District, adm3=r0$EPA, rep=r0$REPLICATION,
			variety_code=r0$maize.variety.planted.in.2019.2020.season,
	        previous_crop="groundnut", crop_rotation="maize; groundnut",
	        dmy_total=r0$Total.biomass..kg.ha.,
			yield=r0$Grain.yld.ha, treatment=r0$TREATMENT.No.,
			longitude=34.1253751, latitude=-14.1832077, trial_id="1")
					

	d1 <- data.frame(adm2=r1$District, adm3=r1$EPA, rep=r1$REPLICATION,
			...
			longitude =35.5737, latitude = -14.9458, trial_id="2")
