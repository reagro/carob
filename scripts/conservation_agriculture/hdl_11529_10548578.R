...
carob_script <- function(path) {
  ...
  "
The database contains data about water use in barley (Hordeum vulgare) and maize
(Zea Mays) production in the Mexican Bajío. Water use and grain yield were 
evaluated under conventional tillage and under conservation agriculture in 
permanent raised beds, both under furrow irrigation and under drip irrigation.
The data in this study were collected between 2016 and 2021 in CIMMYTs’ Bajío 
innovation hub in a research platform (a dedicated field experiment) and in 
innovation modules (side by side comparisons in farmers’ fields). For the platform,
de data base contains data of three maize (summer) and three barley (winter) cycles,
including water use, grain yield and data on key field operations. For the farmers’
fields, the data base contains the yield and water use data from 23 modules, 
as well as fuel use and soil health data from a subset of modules. (2021-06-29)
"
