...
"Farmer field level Trail data has been collected under HOPE Project - Farmer Field Trials at Ahmednagar- Sorghum for the season 2011-12 Grain Yield and Fodder Yield have been recorded in different villages"
   
   uri <- "doi:10.21421/D2/OVLMYM"
   group <- "varieties"
   ...
   meta <- carobiner::get_metadata(uri, path, group, major=1, minor=4, 
      ...
      carob_date="2024-11-12"
   )
   
   f <- ff[basename(ff)=="Ahmednagar FLD data 2011-12.xlsx"]
