...
carob_script <- function(path) {
   ...
   meta <- data.frame(
      ...
      data_institute ="CIP", 
      publication =NA, # http://www.sweetpotatoknowledge.org/wp-content/uploads/2017/10/SA10-Rice-sp-Rice-rotation-agronomic-benefits-and-profitability-analysis.pdf
      project =NA, 
