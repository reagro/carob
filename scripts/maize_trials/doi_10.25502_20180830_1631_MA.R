...
"
	...
	uri <- "doi:10.25502/20180830/1631/MA"
	...
	dset <- data.frame(
		...
		group=group,
		uri = uri,
		data_citation="Menkir, A. (2018). Grain Yield and Other Agronomic Traits of International Maize Trials – Mali, 2016 [Data set]. International Institute of Tropical Agriculture (IITA). https://doi.org/10.25502/20180830/1631/MA",
	...
	d <- mzfun(ff, "Mali_International_Maize_Trials_Regular2016.csv", FALSE)
