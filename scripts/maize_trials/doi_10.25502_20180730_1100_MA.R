...
"
	...
	uri <- "doi:10.25502/20180730/1100/MA"
	...
	dset <- data.frame(
		...
		group=group,
		uri = uri,
		data_citation="Menkir, A. (2018). Grain Yield and Other Agronomic Traits of International Maize Trials – Niger [Data set]. International Institute of Tropical Agriculture (IITA). https://doi.org/10.25502/20180730/1100/MA",
	...
	d <- mzfun(ff, "International_Maize_Trial_Niger_Regular.csv", FALSE)
