...
This dataset contains output of the research for Zaire."
	...
	dset <- data.frame(
		...
		group=group,
		uri = uri,
		data_citation="Menkir, A. (2018). Grain Yield and Other Agronomic Traits of International Maize Trials – Zaire, 1990 - 1993 [Data set]. International Institute of Tropical Agriculture (IITA). https://doi.org/10.25502/20180730/1551/MA",
